...
#define STRING_CONFIG_H_AUTHOR "Matt Poteshman (BIGTREETECH, Ender-3)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKi 69.31
  #define DEFAULT_bedKd 1293.45
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -43, -6,-1.25 }
